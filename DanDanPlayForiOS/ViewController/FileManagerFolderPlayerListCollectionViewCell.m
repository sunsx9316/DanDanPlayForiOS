//
//  FileManagerFolderPlayerListCollectionViewCell.m
//  DanDanPlayForiOS
//
...
@interface FileManagerFolderPlayerListCollectionViewCell ()

@end

@implementation FileManagerFolderPlayerListCollectionViewCell
