...
@interface FileViewController ()<RATreeViewDelegate, RATreeViewDataSource>
...
- (UITableViewCell *)treeView:(RATreeView *)treeView cellForItem:(JHFileTreeNode *)item {
    ...
    if (item.type == JHFileTreeNodeTypeLocation) {
    ...
    UITableViewCell *cell = [treeView dequeueReusableCellWithIdentifier:@"UITableViewCell"];
    if (cell.isFromCache == NO) {
        cell.textLabel.font = NORMAL_SIZE_FONT;
        cell.detailTextLabel.font = NORMAL_SIZE_FONT;
    }
...
- (void)treeView:(RATreeView *)treeView didSelectRowForItem:(JHFileTreeNode *)item {
    ...
    if (item.type == JHFileTreeNodeTypeSection) {
        JHFileLargeTitleTableViewCell *cell = (JHFileLargeTitleTableViewCell *)[treeView cellForItem:item];
...
- (JHBaseTreeView *)treeView {
    if (_treeView == nil) {
        ...
        [_treeView registerClass:[JHFileSectionTableViewCell class] forCellReuseIdentifier:@"JHFileSectionTableViewCell"];
        [_treeView registerClass:[JHFileLargeTitleTableViewCell class] forCellReuseIdentifier:@"JHFileLargeTitleTableViewCell"];
